...
describe('CreateContainerService', () => {
    ...
    it('should be able to create a new container', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not be able to create a new container for a non existing company', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should be able to create a new container with a parent container', () => __awaiter(void 0, void 0, void 0, function* () {
        const company = yield fakeCompanyRepository.create(makeFakeRequest());
    ...
    it('should not be able to create a new container with a non existing parent container', () => __awaiter(void 0, void 0, void 0, function* () {
        const company = yield fakeCompanyRepository.create(makeFakeRequest());
        yield expect(createContainerService.execute({
            company_id: company.id,
            from: 9,
