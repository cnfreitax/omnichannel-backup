...
let CreateCostumerSurvey = class CreateCostumerSurvey {
    ...
    execute(containerData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (containerData.type !== Container_1.ContainerType.SURVEY) {
                throw new AppError_1.default('Wrong message type');
            }
            const surveyContainer = yield this.containerRepository.create(containerData);
            return surveyContainer;
        });
    }
};
CreateCostumerSurvey = __decorate([
    tsyringe_1.injectable(),
    __param(0, tsyringe_1.inject('ContainerRepository')),
    __param(1, tsyringe_1.inject('CompaniesRepository')),
    __metadata("design:paramtypes", [Object, Object])
], CreateCostumerSurvey);
exports.default = CreateCostumerSurvey;
