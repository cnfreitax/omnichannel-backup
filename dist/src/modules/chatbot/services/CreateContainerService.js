...
let CreateContainerService = class CreateContainerService {
    ...
    execute(containerData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (containerData.from) {
                ...
                if (!parentContainer) {
                    throw new AppError_1.default('Parent message does not exist');
                }
            }
            if (!Object.values(Container_1.ContainerType).includes(containerData.type)) {
                throw new AppError_1.default('Invalid container type');
            }
            const container = yield this.containerRepository.create(containerData);
            return container;
        });
    }
};
CreateContainerService = __decorate([
    tsyringe_1.injectable(),
    __param(0, tsyringe_1.inject('ContainerRepository')),
    __param(1, tsyringe_1.inject('CompaniesRepository')),
    __metadata("design:paramtypes", [Object, Object])
], CreateContainerService);
exports.default = CreateContainerService;
