...
let CreateEndOfChatbotMessage = class CreateEndOfChatbotMessage {
    ...
    execute(containerData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const endChatbotMessageExists = yield this.containerRepository.findExistingContainer({
                company_id: containerData.company_id,
                type: containerData.type,
            });
            if (endChatbotMessageExists) {
                throw new AppError_1.default('This company already has a end of chatbot message');
            }
            if (containerData.type !== Container_1.ContainerType.END_CHATBOT) {
                throw new AppError_1.default('Wrong message type');
            }
            const endOfChatbotContainer = yield this.containerRepository.create(containerData);
            return endOfChatbotContainer;
        });
    }
};
CreateEndOfChatbotMessage = __decorate([
    tsyringe_1.injectable(),
    __param(0, tsyringe_1.inject('ContainerRepository')),
    __param(1, tsyringe_1.inject('CompaniesRepository')),
    __metadata("design:paramtypes", [Object, Object])
], CreateEndOfChatbotMessage);
exports.default = CreateEndOfChatbotMessage;
