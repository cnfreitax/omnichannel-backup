...
const FakeAvailableUserRepository_1 = __importDefault(require("../repositories/fakes/FakeAvailableUserRepository"));
...
describe('User SignUp', () => {
    beforeEach(() => {
        ...
        fakeAvailable = new FakeAvailableUserRepository_1.default();
        authUser = new AuthUserService_1.default(fakeUserRepository, fakeHashProvider, fakeAvailable);
