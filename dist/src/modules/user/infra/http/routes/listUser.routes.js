...
const ensureAuthencticatedAdmUser_1 = __importDefault(require("../middlewares/ensureAuthencticatedAdmUser"));
const userController = new UserController_1.default();
const listUserRouter = express_1.Router();
listUserRouter.use(ensureAuthencticatedAdmUser_1.default);
