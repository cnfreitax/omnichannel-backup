...
const DeleteCompanyService_1 = __importDefault(require("@modules/company/services/DeleteCompanyService"));
class CompaniesController {
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const deleteComapnyService = tsyringe_1.container.resolve(DeleteCompanyService_1.default);
            const company = yield deleteComapnyService.execute(Number(id));
            return res.json(class_transformer_1.classToClass(company));
        });
    }
}
